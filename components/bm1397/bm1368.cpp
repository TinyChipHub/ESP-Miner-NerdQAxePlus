...
void BM1368::requestChipTemp(int nr) {
    send2(CMD_READ_SINGLE, nr * 2, 0xB4);
    send6(CMD_WRITE_SINGLE, nr * 2, 0xB0, 0x80, 0x00, 0x00, 0x00);
    send6(CMD_WRITE_SINGLE, nr * 2, 0xB0, 0x00, 0x02, 0x00, 0x00);
    send6(CMD_WRITE_SINGLE, nr * 2, 0xB0, 0x01, 0x02, 0x00, 0x00);
    send6(CMD_WRITE_SINGLE, nr * 2, 0xB0, 0x10, 0x02, 0x00, 0x00);
}
